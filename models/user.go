...
"errors"
"encoding/base64"
"github.com/muxiyun/MAE/utils/small"
"github.com/muxiyun/MAE/utils/aestool"
)
...
/*base64(aestool(uid)) + "." + base64(aestool(role)) + "." + base64(aestool(generated unix timestamp))*/
